  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: 'rounded-l-md [&>button]:bg-primary [&>button]:text-primary-foreground [&>button]:hover:bg-primary/90',
        range_end: 'rounded-r-md [&>button]:bg-primary [&>button]:text-primary-foreground [&>button]:hover:bg-primary/90',
        range_middle: '[&>button]:bg-primary/15 [&>button]:text-foreground [&>button]:rounded-none [&>button]:hover:bg-primary/25',
