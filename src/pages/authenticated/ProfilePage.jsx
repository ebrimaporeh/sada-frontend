...
import { OverviewTab } from './OrganizationDetail/OverviewTab'
...
// missing fields OverviewTab needs (member_count, organization_type_name,
// created_at) -- fetch the full record via useOrganization() instead of
// reusing that lean one.
