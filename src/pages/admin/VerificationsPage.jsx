...
export function VerificationsPage() {
  ...
  return (
    <div className="min-h-full flex flex-col">
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      {ID_TYPE_LABELS[req.id_type]} · Submitted {formatDate(req.created_at)}
                    </p>
                  </div>
      ...
      <Sheet isOpen={isSheetOpen} onClose={() => setIsSheetOpen(false)} title="Verification Request">
        {selected && (
              ...
              <div className="space-y-3 border-t pt-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    disabled={reviewVerification.isPending || !reason.trim()}
                  ...
                  >
                    {reviewVerification.isPending ? <Loader2 className="w-4 h-4 animate-spin" /> : <XCircle className="w-4 h-4" />} Reject
                  </button>
                  <button
                  ...
                  >
                    {reviewVerification.isPending ? <Loader2 className="w-4 h-4 animate-spin" /> : <CheckCircle2 className="w-4 h-4" />} Approve
                  </button>
                </div>
              </div>
            )}
