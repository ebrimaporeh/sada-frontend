...
import { MapPin, Users, Clock, Share2, Flag, Heart, ChevronLeft, Lock } from 'lucide-react'
          ...
          {tab === 'story' && (
            <div className="prose prose-sm max-w-none">
              {campaign.story.split('\n\n').map((para, i) => (
                <p key={i} className="text-sm leading-relaxed text-foreground/90 mb-4">{para}</p>
              ))}
            </div>
          )}
            ...
            <div className="space-y-4">
              {campaign.updates.length === 0 ? (
                ...
                campaign.updates.map((u) => (
                  <div key={u.id} className="border rounded-xl p-5">
        ...
        <div className="hidden lg:block">
          <div className="sticky top-24 bg-card border rounded-2xl p-5 space-y-5 shadow-sm">
            ...
            <div className="flex gap-2">
              ...
              <button className="flex items-center justify-center gap-2 border rounded-lg px-3 py-2.5 text-sm hover:bg-accent transition-colors">
